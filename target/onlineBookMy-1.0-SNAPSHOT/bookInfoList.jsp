...
<div class="top1">
    ...
    <div class="top1_2">
        ...
        <div class="top1_2_r">
            <ul class="other">
                <li><a href="${pageContext.request.contextPath}/gouwuche.jsp"><img src="images/car.gif"/><br/>购物车</a>
                </li>
        ...
        <div class="middle_right6con">
            <div class="warpbor">
                <c:forEach var="books" items="${requestScope.bookInfos}">
                    <div class="middle_right6con">
                        <div class="warpbor">
                            <div class="leftshop"><a
                                    href="${pageContext.request.contextPath}/ShowBookInfoServlet?id=${books.bookId}">
                                <img src="${pageContext.request.contextPath}/imgsx/${books.smallImg}" width="98"
                                     height="160"/></a></div>
                            <div class="righttext"><h3>目送：${books.author}</h3>
                                <p/>
                                <span class="fontcc">(50629条评论)</span><br/>
                                    ${books.author}著/${books.pbdate}<br/>
                                    ${books.context}
                                <span class="xiangx">${books.hyprice}<span
                                        class="textde">${books.price}</span> 折扣：${books.hyprice / books.price}折
     			   <a href="<%=request.getContextPath() %>/AddGwcItemServlet?id=${books.bookId}"><img
                           src="images/btn_buy.gif"/></a>
...
<div class="footer3">
    <div class="footer3_in">
        <a href="http://product.dangdang.com/23690437.html#ddclick?act=click&pos=23690437_0_1_p&cat=01.38.07.00.00.00&key=&qinfo=&pinfo=7023_1_60&minfo=&ninfo=&custid=&permid=20160414103850170642707113084209851&ref=&rcount=&type=&t=1460601593000&searchapi_version=test_new">公司简介</a><span>|</span><a
            href="#">免责条款</a><span>|</span><a href="#">隐私保护</a><span>|</span><a href="#">咨询热点</a><span>|</span><a
            href="#">合作招募</a><span>|</span><a href="#">配送方式</a><span>|</span><a href="#">联系我们</a>
    </div>
    <div class="footer2">
