...
<table width="160" border="0" cellspacing="0" cellpadding="2">
    ...
    <tr>
        <td width="40">&nbsp;</td>
        <td class="wr4" width="120"><a
                href="<%= request.getContextPath() %>/FindAllCustomerInfoServlet?nowPage=1"
                target="mainFrame">用户基本信息</a>
        </td>
    </tr>
    <tr>
        <td width="40">&nbsp;</td>
...
<table width="160" border="0" cellspacing="0" cellpadding="2">
    ...
    <table width="160" border="0" cellspacing="0" cellpadding="2">
        ...
        <tr>
            <td width="40">&nbsp;</td>
            <td class="wr4" width="120"><a href="<%=request.getContextPath()%>/FindAllFavoriteServlet?nowPage=1"
                                           target="mainFrame">评价管理</a>
            </td>
        </tr>
        <tr>
            <td width="40">&nbsp;</td>
    ...
    <table width="160" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td background="images/ht04.jpg" class="wr4">
                <div align="center">
                    <a href="systemSet.htm" target="mainFrame">系统设置</a>
                </div>
            </td>
            <td width="12"><img src="images/ht03.jpg" width="12" height="20">
            </td>
