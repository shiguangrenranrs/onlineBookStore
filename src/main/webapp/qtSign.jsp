    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="panel panel-default">
                <div class="panel-heading"><i class="glyphicon glyphicon-ok-sign"></i>&nbsp;会员注册</div>
                <div class="panel-body">
                    <form action="<%=request.getContextPath()%>/QtSignServlet" method="post" accept-charset="utf-8">
                        ...
                        <p><a href="#">忘记密码</a></p>
                        <button type="button" class="btn btn-primary" onclick="check(form)">注册</button>
                    </form>
